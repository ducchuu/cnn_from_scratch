...
def draw_network(screen, step):
    ...
    if step >= 5:
        ...
        screen.blit(line1, (output_pos[0] + 40, output_pos[1] - 40))
        screen.blit(line2, (output_pos[0] + 40, output_pos[1] - 20))
        screen.blit(line3, (output_pos[0] + 40, output_pos[1]))
        screen.blit(line4, (output_pos[0] + 40, output_pos[1] + 20))
